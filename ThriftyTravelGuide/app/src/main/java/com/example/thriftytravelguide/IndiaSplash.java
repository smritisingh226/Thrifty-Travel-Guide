//Splash Screen that directs the user to India activity
...
public class IndiaSplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_india_splash);

        text = findViewById(R.id.secondactivity_india);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(getApplicationContext(),indiaDescription.class);
